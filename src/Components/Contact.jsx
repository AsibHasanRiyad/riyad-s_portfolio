            ...
            <div className="w-full px-8 mx-auto overflow-hidden bg-transparent rounded-lg   lg:max-w-xl shadow-gray-300/50 dark:shadow-black/50">
              ...
              <form className="mt-6">
                ...
                <div className="w-full mt-6">
                  ...
                  <textarea
                    className="block w-full h-32 px-5 py-3 mt-2 text-gray-200 placeholder-gray-600  bg-[#1C1C22]  rounded-md md:h-48     focus:-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40"
                    placeholder="Message"
                  ></textarea>
                </div>

                <button className="w-full px-6 py-3 mt-6 text-base font-medium tracking-wide text-white capitalize bg-gradient-to-r rounded-md from-indigo-700 via-purple-600 to-pink-700 cursor-pointer ">
                  get in touch
                </button>
              </form>
            </div>
